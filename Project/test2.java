...
public class test2 {
    ...
    public static void main(String[] arg) throws IOException {
        ...
        FileWriter writer = new FileWriter("output_500B.txt");
        FileWriter writer1 = new FileWriter("records_500B.txt");
        dataRow = TSVFile.readLine(); // Read next line of data.
        while (dataRow != null) {
            remainingSpaces = 460; // 100b - 40(for extra space) bytes
            blockArray.clear();
            itemNumber = 0;
            startingByte = 100; // For unique index number
            while (dataRow != null && remainingSpaces > dataRow.getBytes().length) {
                ...
                if (itemNumber == 26) { // Setting max number of records in a datablock to be = 26 for easier
        ...
        try {
            ...
            file = new Scanner(new File("records_500B.txt"));
            writer2 = new PrintWriter("recordsnoemptylines_500B.txt");
        ...
        File file1 = new File("records_500B.txt");
        File file2 = new File("recordsnoemptylines_500B.txt");
        file1.delete();
